...
describe('ProcessesOverviewPage completed state', () => {
  it('hides suspend/activate actions for completed instance', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByLabelText('Suspend')).not.toBeInTheDocument();
      expect(screen.queryByLabelText('Activate')).not.toBeInTheDocument();
    });
  });
});
