...
import { requireFileEditAccess } from '@shared/middleware/projectAuth.js';
import { AcquireLockRequestSchema, ReleaseLockRequestSchema } from '@shared/schemas/git/index.js';
...
import { EDIT_ROLES, MANAGE_ROLES } from '@shared/constants/roles.js';
